...
const char *on8citPageCss() {
    return
        ...
        ".stationRow.dragging{opacity:.4}"
        ".stationRow.dropTarget{outline:2px dashed #FFD400;outline-offset:-2px}"
        ".dragHandle{display:flex;align-items:center;justify-content:center;"
        "padding:0 .35em;color:#556;cursor:grab;user-select:none;font-size:1.2em}"
        ".dragHandle:hover{color:#FFD400}"
